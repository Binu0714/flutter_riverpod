...
abstract class $CommentModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int postId, String name, String body});
}
...
class _$CommentModelImpl implements _CommentModel {
  ...
  @override
  String toString() {
    return 'CommentModel(id: $id, postId: $postId, name: $name, body: $body)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, postId, name, body);
